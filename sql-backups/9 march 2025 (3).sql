...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2025 at 11:31 AM
...
(1, 'Toolbox', 'App store to manage and install apps', '/toolbox'),
(2, 'Inventory', 'Manage and track inventory items', '/inventory'),
(3, 'Order_Book', 'Keep track of customer orders', '/order_book'),
(4, 'Stock_Entry', 'Manage stock entries and updates', '/stock_entry'),
(5, 'Access_Control', 'Manage roles and permissions (Admin only)', '/access_control'),
(6, 'Analytics', 'Analyze data and generate reports', '/analytics'),
(7, 'Payments', 'Manage and process payments', '/payments'),
(8, 'Barcode_Module', 'Manage barcode scanning and integration', '/barcode_module'),
(9, 'RFID', 'Handle RFID-based stock management', '/rfid'),
(10, 'Vendor_List', 'Manage and track vendor information', '/vendor_list');
...
(3, 1, '2025-03-09 15:09:36', '2025-03-09 16:09:36', 1),
(6, 2, '2025-03-09 15:41:11', '2025-03-09 16:41:11', 1),
(8, 3, '2025-03-09 15:08:58', '2025-03-09 16:08:58', 1),
(84, 3, '2025-03-09 15:53:13', '2025-03-09 16:53:13', 1);
...
(3, 'test1', 'test1@123', 'test', NULL, NULL, 3, 2, '2025-03-08 20:00:13');
...
--
ALTER TABLE `user_apps`
  MODIFY `user_app_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
